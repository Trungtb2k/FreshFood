...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        ...
                        <div class="hero__item set-bg" data-setbg="{{asset('public/Frontend/images/banner.jpg')}}">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="{{asset('public/Frontend/images/payment-item.png')}}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{asset('public/Frontend/js/sweetaleart.min.js')}}"></script>
