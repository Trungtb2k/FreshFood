        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{('public/FrontEnd/images/logo.png')}}" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="{{URL::to('/trang-chu')}}">Home</a></li>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="{{('public/FrontEnd/images/img-pro-01.jpg')}}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Delica omtantur </a></h6>
                            <p>1x - <span class="price">$80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="{{('public/FrontEnd/images/img-pro-02.jpg')}}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Omnes ocurreret</a></h6>
                            <p>1x - <span class="price">$60.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="{{('public/FrontEnd/mages/img-pro-03.jpg')}}" class="cart-thumb" alt="" /></a>
        ...
        <div class="main-instagram owl-carousel owl-theme">
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-01.jpg')}}" alt="" />
                    <div class="hov-in">
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-02.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-03.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-04.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-05.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-06.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-07.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-08.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{('public/FrontEnd/images/instagram-img-09.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
