                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <form action="{{URL::to('/save-cart')}}" method="POST">
                            ...
                            <button type="submit" data-id_product="{{$value->product_id}}" class="primary-btn add-to-cart" name="add-to-cart">ADD TO CARD</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{URL::to('public/Upload/Product/'.$related->product_image)}}">
